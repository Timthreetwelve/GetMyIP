...
#pragma warning restore MVVMTK0042 // Prefer using [ObservableProperty] on partial properties
    ...
    [
        ...
        new () {Language = "German",   LanguageCode = "de-DE", LanguageNative = "Deutsch",    Contributor = "uDEV2019"},
        new () {Language = "French",   LanguageCode = "fr-FR", LanguageNative = "Français",   Contributor = "Largo"},
        ...
        new () {Language = "Spanish",  LanguageCode = "es-ES", LanguageNative = "Español",    Contributor = "Copilot app"},
    ];
