...
en.DeleteConfigFiles=Do you want to remove the settings files?%nSelect 'No' if you plan on reinstalling.

ca.ViewReadme=Veure el fitxer RadMe
ca.AppIsRunning=s'està executant, tanqueu-lo per continuar amb la instal·lació.
ca.DeleteConfigFiles=Voleu eliminar la configuració i excloure fitxers?5nSeleccioneu 'No' si teniu previst tornar a instal·lar.
...
de.DeleteConfigFiles=Möchten Sie die Einstellungen und Ausschlussdateien entfernen?%nWählen Sie 'Nein', wenn Sie eine Neuinstallation planen.
...
nl.DeleteConfigFiles=Wil je de instellingen en uitsluitingsbestanden verwijderen?%nSelecteer 'Nee' als je van plan bent om opnieuw te installeren.
